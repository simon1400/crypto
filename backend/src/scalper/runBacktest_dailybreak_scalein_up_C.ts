...
async function main() {
  console.log('Daily Breakout — Variant C (limit entry): baseline vs scale-in UP (pyramiding @ 50% to TP1)')
  ...
  console.log(`Baseline check (must be ≈$8175 from AB-script for C limit): final=$${validate.finalDeposit.toFixed(2)}`)
  console.log()

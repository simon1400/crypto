 ...
 *
 * Run: cd backend && npx tsx src/scalper/runBacktest_dailybreak_scalein_up_A.ts
 */
...
async function main() {
  console.log('Daily Breakout — Variant A: baseline vs scale-in UP (pyramiding @ 50% to TP1)')
